    ...
    return new Promise<TOAUser>((resolve, reject) => {
      this.userToToken(user)
        .then((token) => {
          ...
          this.http.get(this.baseUrl + '/user', { headers: headers }).subscribe(
            (data: any) => {
    ...
    return new Promise<any[]>((resolve, reject) => {
      this.userToToken(user)
        .then((token) => {
          ...
          this.http.get(this.baseUrl + '/generateKey', { headers: headers }).subscribe(
            (data: any) => {
              resolve(data);
            },
            (err: any) => {
    ...
    return new Promise<any>((resolve, reject) => {
      this.userToToken(user)
        .then((token) => {
          ...
          this.http.post(this.baseUrl + '/user/addFavorite', key, { headers: headers }).subscribe(
            (data: any) => {
              resolve(data);
            },
            (err: any) => {
    ...
    return new Promise<any>((resolve, reject) => {
      this.userToToken(user)
        .then((token) => {
          ...
          this.http
            .post(this.baseUrl + '/user/removeFavorite', key, { headers: headers })
            .subscribe(
              (data: any) => {
                resolve(data);
              },
    ...
    return new Promise<any[]>((resolve, reject) => {
      this.userToToken(user)
        .then((token) => {
          ...
          this.http.get(this.baseUrl + '/eventKey', { headers: headers }).subscribe(
            (data: any) => {
              resolve(data);
            },
            (err: any) => {
    ...
    return new Promise<any[]>((resolve, reject) => {
      this.userToToken(user)
        .then((token) => {
          ...
          this.http.post(this.baseUrl + '/playlistMatchify', body, { headers: headers }).subscribe(
            (data: any) => {
              resolve(data);
            },
            (err: any) => {
    ...
    return new Promise<any[]>((resolve, reject) => {
      this.userToToken(user)
        .then((token) => {
          ...
          this.http.post(this.baseUrl + '/setVideos', videos, { headers: headers }).subscribe(
            (data: any) => {
              resolve(data);
            },
            (err: any) => {
    ...
    return new Promise<any[]>((resolve, reject) => {
      this.userToToken(user)
        .then((token) => {
          ...
          this.http.post(this.baseUrl + '/createEvent', eventData, { headers: headers }).subscribe(
            (data: any) => {
              resolve(data);
            },
            (err: any) => {
    ...
    return new Promise<any[]>((resolve, reject) => {
      this.userToToken(user)
        .then((token) => {
          ...
          this.http
            .post(this.baseUrl + '/updateEvent', [eventData], { headers: headers })
            .subscribe(
              (data: any) => {
                resolve(data);
              },
    ...
    return new Promise<any[]>((resolve, reject) => {
      this.userToToken(user)
        .then((token) => {
          ...
          this.http.post(this.baseUrl + '/addMedia', mediaData, { headers: headers }).subscribe(
            (data: any) => {
              resolve(data);
            },
            (err: any) => {
    ...
    return new Promise<any[]>((resolve, reject) => {
      this.userToToken(user)
        .then((token) => {
          ...
          this.http
            .post(this.baseUrl + '/addMediaToPending', mediaData, { headers: headers })
            .subscribe(
              (data: any) => {
                resolve(data);
              },
    ...
    return new Promise<any[]>((resolve, reject) => {
      this.userToToken(user)
        .then((token) => {
          ...
          this.http.get(this.baseUrl + '/getPendingMedia', { headers: headers }).subscribe(
            (data: any) => {
              resolve(data);
            },
            (err: any) => {
    ...
    return new Promise<any[]>((resolve, reject) => {
      this.userToToken(user)
        .then((token) => {
          ...
          this.http
            .post(this.baseUrl + '/user/addSuggestion', suggestionData, { headers: headers })
            .subscribe(
              (data: any) => {
                resolve(data);
              },
    ...
    return new Promise<any[]>((resolve, reject) => {
      this.userToToken(user)
        .then((token) => {
          ...
          this.http.post(this.baseUrl + '/addStream', streamData, { headers: headers }).subscribe(
            (data: any) => {
              resolve(data);
            },
            (err: any) => {
    ...
    return new Promise<any[]>((resolve, reject) => {
      this.userToToken(user)
        .then((token) => {
          ...
          this.http.post(this.baseUrl + '/hideStream', streamData, { headers: headers }).subscribe(
            (data: any) => {
              resolve(data);
            },
            (err: any) => {
    ...
    return new Promise<any[]>((resolve, reject) => {
      this.userToToken(user)
        .then((token) => {
          ...
          this.http.post(this.baseUrl + '/toaapi', body, { headers: headers }).subscribe(
            (data: any) => {
              resolve(data);
            },
            (err: any) => {
    ...
    return new Promise<any[]>((resolve, reject) => {
      this.userToToken(user)
        .then((token) => {
          ...
          this.http.put(this.baseUrl + '/toaapi', body, { headers: headers }).subscribe(
            (data: any) => {
              resolve(data);
            },
            (err: any) => {
    ...
    return new Promise<any[]>((resolve, reject) => {
      this.userToToken(user)
        .then((token) => {
          ...
          this.http.delete(this.baseUrl + '/toaapi', { headers: headers }).subscribe(
            (data: any) => {
              resolve(data);
            },
            (err: any) => {
    ...
    return new Promise<any[]>((resolve, reject) => {
      this.userToToken(user)
        .then((token) => {
          ...
          this.http.get(this.baseUrl + '/firstEvents', { headers: headers }).subscribe(
            (data: any) => {
              resolve(data);
            },
            (err: any) => {
    ...
    return new Promise<any[]>((resolve, reject) => {
      this.userToToken(user)
        .then((token) => {
          ...
          this.http.get(this.baseUrl + '/firstTeams', { headers: headers }).subscribe(
            (data: any) => {
              resolve(data);
            },
            (err: any) => {
    ...
    return new Promise<any[]>((resolve, reject) => {
      this.userToToken(user)
        .then((token) => {
          ...
          this.http.get(this.baseUrl + '/user/getEventSettings', { headers: headers }).subscribe(
            (data: any) => {
              resolve(data);
            },
            (err: any) => {
    ...
    return new Promise<any[]>((resolve, reject) => {
      this.userToToken(user)
        .then((token) => {
          ...
          this.http
            .post(this.baseUrl + '/user/updateEventSettings', settings, { headers: headers })
            .subscribe(
              (data: any) => {
                resolve(data);
              },
    ...
    return new Promise<any[]>((resolve, reject) => {
      this.userToToken(user)
        .then((token) => {
          ...
          this.http
            .post(this.baseUrl + '/user/saveMessagingToken', messagingToken, { headers: headers })
            .subscribe(
              (data: any) => {
                resolve(data);
              },
